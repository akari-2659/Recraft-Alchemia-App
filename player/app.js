(()=>{
  ...
  function readBinding(){
    ...
    const loginKey=String(sessionStorage.getItem('ra-proto-login-player-key')||'').trim();
    const accountKey=loginKey?`ra-proto-bind-account-${encodeURIComponent(loginKey)}`:'';
    const raw=(accountKey?localStorage.getItem(accountKey):'')||localStorage.getItem('ra-proto-bind-'+role)||localStorage.getItem('ra-proto-bind-player')||'';
